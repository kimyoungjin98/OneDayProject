...
public class DBInfo {
	...
	public static class 섭취정보 {
	      ...
	      public final static String fd_serv   = "제공량";
	      public final static String fd_total   = "총내용량";
	      public final static String fd_energy   = "에너지";
...
//	      public final static String cp_item   = "주요품목";
	      ...
	      public final static String my_seq   = "일련번호";
	      public final static String my_date   = "섭취일자";
	      public final static String my_pdcode   = "식품코드";
	      public final static String my_eat   = "섭취량";
	   ...
	   public static class 섭취정보계산 {
	      ...
	      public static final String mf_carvo = "탄수화물";
