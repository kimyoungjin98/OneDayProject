...
public class DBInfo {
	...
	public static class FOOD {
		...
		public static final String fd_code = "식품코드";
		public static final String fd_name = "식품명";
		public static final String fd_year = "출시연도";
		public static final String fd_ccode = "제조사코드";
		public static final String fd_icode = "분류코드";
		public static final String fd_once = "제공량";
		public static final String fd_capa = "총내용량";
		public static final String fd_cal = "에너지";
		public static final String fd_protein = "단백질";
		public static final String fd_fat = "지방";
		public static final String fd_carbo = "탄수화물";
		public static final String fd_sugar = "총당류";

		public static final String cp_name = "제조사명";
		public static final String cp_ceo = "대표";
		public static final String cp_tel = "대표전화";
		public static final String cp_addr = "주소";
		public static final String cp_item = "주요품목";

		public static final String it_name = "분류명";
