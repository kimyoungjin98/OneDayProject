CREATE TABLE tbl_foods(
    ...
    fd_year	NUMBER,
    fd_ccode	CHAR(6 BYTE)	NOT NULL,
    fd_icode	CHAR(6 BYTE)	NOT NULL,	
    fd_ones	NUMBER(10,2),
    fd_capa	NUMBER(10,2),
    fd_cal	NUMBER(10,2),
...
-- 식품정보와 제조자정보를 JOIN하여 데이터가 정상으로 임포트되었는지 확인
...
-- 누가 부모이고 누가 자식인지 파악
-- 자식 : tbl_foods / 부모 : tbl_company, tbl_items
